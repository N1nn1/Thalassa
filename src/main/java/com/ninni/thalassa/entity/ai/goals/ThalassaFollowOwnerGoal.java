...
public class ThalassaFollowOwnerGoal extends Goal {
    private final ThalassaTameableFishEntity tameable;
    ...
    public ThalassaFollowOwnerGoal(ThalassaTameableFishEntity tameable, double speed, float minDistance, float maxDistance) {
    ...
    public boolean canStart() {
        ...
        if (livingEntity == null) {
            ...
            return false;
        } else if (this.tameable.isStaying()) {
            return false;
